...
C. Plot the value of the likelihood for different values of parameter : put on the x-axis,
with values = (0.01,0.02,0.99) and likelihood on the y-axis. Repeat this plot for the
log-likelihood.
...
D. At what value of is the observed data most likely? Why must this value be the same for
 both plots?
